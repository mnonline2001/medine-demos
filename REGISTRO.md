...
| Juan Carlos Hernández — abogado (Sucre) | `juan-carlos-hernandez` | crema #f6f1e7 + tinta #1a2238 + ámbar #a97f2f | Playfair Display + Source Sans 3; editorial serena; base clara cálida | expediente editorial en columna angosta (cláusulas romanas, capitulares, §) | sello circular SVG que se estampa + frase que se entinta con el scroll | nav aparece-al-subir / footer-índice romano | renglones de formulario sin cards; CTA subrayado tipográfico | 2026-07-23 | por enviar (él espera el mensaje) |
