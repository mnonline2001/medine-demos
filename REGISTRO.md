...
| Primera Iglesia Bautista de Maturín — iglesia (Maturín) | `pib-maturin` | piedra #f3eede + tinta marino #10233b + oro #b8860f; vidrios jewel (azul #1f4f95 / rubí #9e2b3a / esmeralda #2f6d5b / ámbar) | Cormorant Garamond + Public Sans; editorial litúrgico sereno con aire; base clara con hero oscuro de vitral | vitral narrado en capítulos sticky (grid label-sticky + cuerpo) | ventana de vitral SVG (arco ojival + rosetón) con barrido de luz mask/mix-blend + versículo en background-clip:text de degradado de vidrio | riel de puntos por capítulo (fijo, desktop) / footer-tarjeta flotante sobre banda de marca | paneles de vidrio con línea de plomo (borde superior de color) + botón con arco de ventana (radius 999/999/8/8) | 2026-07-25 | pieza propia — no prospecto (portafolio/invitación) |
